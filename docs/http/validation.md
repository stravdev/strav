...
```typescript
import { validate, required, string, integer, min, max, email } from '@strav/core/validation'
...
```typescript
import { required, string, min, max, email, enumOf, oneOf, regex } from '@strav/core/validation'
...
import { enumOf, string } from '@strav/core/validation'
import { UserRole } from '../enums/user'
...
```typescript
import type { Rule } from '@strav/core/validation'

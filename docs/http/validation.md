...
```typescript
import { validate, required, string, integer, min, max, email } from '@strav/http/validation'
...
```typescript
import { required, string, min, max, email, enumOf, oneOf, regex } from '@strav/http/validation'
...
import { enumOf, string } from '@strav/http/validation'
import { UserRole } from '../enums/user'
...
```typescript
import type { Rule } from '@strav/http/validation'
